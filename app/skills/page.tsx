  ...
  return (
    <section
      ...
      text-gray-800 font-sans
        ...
        bg-size-[24px_24px]"
    >
      <h1 className="pt-20 mb-5 ml-50 text-6xl font-bold">Skills</h1>
      <div className="flex flex-wrap gap-5 justify-center px-30 mt-20 py-20 mx-50 border-2 rounded-xl ">
